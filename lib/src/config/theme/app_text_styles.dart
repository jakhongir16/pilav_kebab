...
class ThemeTextStyles extends ThemeExtension<ThemeTextStyles> {
  ...
  static const ThemeTextStyles light = ThemeTextStyles(
    ...
    sfProDisplay2: TextStyle(
      color: Colors.black,
      fontSize: 15,
      fontWeight: FontWeight.w400,
    ),
    sfProDisplay3: TextStyle(
      color: Colors.black,
      fontSize: 13,
      fontWeight: FontWeight.w500,
    ),
    sfProDisplay4: TextStyle(
  ...
  ThemeExtension<ThemeTextStyles> copyWith({
    ...
    TextStyle? sfProDisplay4,
      ...
      ThemeTextStyles(
        ...
        sfProDisplay: sfProDisplay ?? this.sfProDisplay,
  ...
  ThemeExtension<ThemeTextStyles> lerp(
    ...
    return ThemeTextStyles(
      ...
      boldSubHeadline: TextStyle.lerp(boldSubHeadline, other.boldSubHeadline, t)!,
      sfProDisplay: TextStyle.lerp(sfProDisplay, other.sfProDisplay, t)!,
