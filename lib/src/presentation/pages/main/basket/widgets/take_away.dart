...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_0_fill.shader = ui.Gradient.linear(Offset(size.width * 0.2891038, size.height * 0.4484202),
        Offset(size.width * 1.156558, size.height * 1.541077), [
      Color(0xffFFD459).withOpacity(1),
      Color(0xffFFD355).withOpacity(1),
      Color(0xffFFCF4A).withOpacity(1),
      Color(0xffFFC838).withOpacity(1),
      Color(0xffFFBF1F).withOpacity(1),
    ...
    paint_1_fill.shader = ui.Gradient.linear(Offset(size.width * 0.8372106, size.height * 0.1951038),
        Offset(size.width * 0.8372106, size.height * 2.510990), [
      Color(0xffE58200).withOpacity(0),
      Color(0xffE27F04).withOpacity(0.039216),
      Color(0xffC15D2F).withOpacity(0.466667),
      Color(0xffAD4949).withOpacity(0.8),
      Color(0xffA64153).withOpacity(1)
    ], [
      0,
      0.0396,
      0.4671,
    ...
    paint_2_fill.shader = ui.Gradient.linear(Offset(size.width * 0.3681894, size.height * 0.3252615),
    ...
    paint_3_fill.shader = ui.Gradient.linear(Offset(size.width * 0.2577471, size.height * -8.592904),
        Offset(size.width * 0.6748058, size.height * 0.3311298), [
      Color(0xffFFD459).withOpacity(1),
      Color(0xffFFD355).withOpacity(1),
      Color(0xffFFCF4A).withOpacity(1),
      Color(0xffFFC838).withOpacity(1),
    ...
    paint_4_fill.shader = ui.Gradient.linear(Offset(size.width * 0.7159942, size.height * 0.1691260),
    ...
    paint_5_fill.shader = ui.Gradient.linear(Offset(size.width * 0.5004538, size.height * 0.9443913),
    ...
    paint_6_fill.shader = ui.Gradient.linear(Offset(size.width * 0.6386587, size.height * 0.6313663),
        Offset(size.width * -47.01962, size.height * 0.2575087), [
      Color(0xffE58200).withOpacity(0),
      Color(0xffE27F04).withOpacity(0.039216),
      Color(0xffC15D2F).withOpacity(0.466667),
      Color(0xffAD4949).withOpacity(0.8),
    ...
    paint_7_fill.shader = ui.Gradient.linear(Offset(size.width * 0.3774817, size.height * 0.3641577),
        Offset(size.width * 0.7720731, size.height * 0.8068288), [
      Color(0xffFF6E3A).withOpacity(1),
      Color(0xffFF6440).withOpacity(1),
      Color(0xffFF4B52).withOpacity(1),
      Color(0xffFF216E).withOpacity(1),
      Color(0xffFF0084).withOpacity(1)
    ], [
      0,
      0.1596,
      0.4266,
    ...
    paint_8_fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.09676250, size.height * 0.7050606),
        Offset(size.width * 0.3206221, size.height * 0.7050606),
        [Color(0xff45425A).withOpacity(1), Color(0xff2D3251).withOpacity(1)],
        [0, 1]);
    ...
    paint_9_fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.09676250, size.height * 0.8007587),
        Offset(size.width * 0.3206221, size.height * 0.8007587),
        [Color(0xff45425A).withOpacity(1), Color(0xff2D3251).withOpacity(1)],
        [0, 1]);
    ...
    paint_10_fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.09676250, size.height * 0.8964567),
        Offset(size.width * 0.2750212, size.height * 0.8964567),
        [Color(0xff45425A).withOpacity(1), Color(0xff2D3251).withOpacity(1)],
        [0, 1]);
